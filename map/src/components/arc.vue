<template>
  <div style="margin-top:240px;padding-bottom:80px">
    <div style="position:relative;left:27%;width:46%;top:20px">
      ...
      >该图即新冠肺炎感染人员于全国分布情况以及密集程度。由图可见，全国疫情分布多集中于东南地区，而西南地区仅有少数散发病例。总体而言，我国确诊较严重的省市有：武汉，。。。相对较多省市有：。。。等。</p>
    </div>
    <div class="heat">
    ...
    <div style="position:relative;left:27%;width:46%;top:50px">
      ...
      <p
        style="margin-top:15px;color:#000"
      >尤其是我国第一阶梯地区，由于海拔高，面积广，人员流动小，几乎无确诊病例。至于东南地区，以武汉为中心确诊案例向外逐渐递减，人口密集地区，农村以及交通枢纽城市（部分沿海城市）确诊人数相对较多。</p>
    </div>
    <div class="heat" style="margin-top:30px">
      <img src="../assets/grid.png" style="width:100%" />
    </div>
    <div style="position:relative;left:27%;width:46%;top:40px">
